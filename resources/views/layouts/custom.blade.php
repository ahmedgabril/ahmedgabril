                ...
                <div class="auth-wrapper auth-v2">
                    <div class="m-0 auth-inner row">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="ml-1 brand-text text-primary">Vuexy</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="p-5 d-none d-lg-flex col-lg-8 align-items-center">
                            <div class="px-5 w-100 d-lg-flex align-items-center justify-content-center"><img class="img-fluid" src="../../../app-assets/images/pages/login-v2.svg" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="px-2 d-flex col-lg-4 align-items-center auth-bg p-lg-5">
                            <div class="mx-auto col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2">
                                <h2 class="mb-1 card-title font-weight-bold">Welcome to Vuexy! 👋</h2>
                                <p class="mb-2 card-text">Please sign-in to your account and start the adventure</p>
                                <form class="mt-2 auth-login-form" action="index.html" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            ...
                                            <div class="input-group-append"><span class="cursor-pointer input-group-text"><i data-feather="eye"></i></span></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <p class="mt-2 text-center"><span>New on our platform?</span><a href="page-auth-register-v2.html"><span>&nbsp;Create an account</span></a></p>
