...
<div class="content-header">
          ...
          <div class="mb-2 row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">اداره العملاء</li> /
            ...
            <div class="card-header">
                ...
                <div class="row"> 
                  ...
                  <div class=" col-sm-3 form-group" style="margin-top:32px">
                      <button type="button"  wire:click.prevent="showmodel" class="btn btn-block btn-outline-success"><i class="fas fa-plus-circle"></i> اضافه عميل </button>
                  </div>
              ...
              <table class="table table-head-fixed text-nowrap table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>@if ($getdata->customer_status == 0 )
                    
                       <span class="badge bg-danger">عادى </span>
                    @elseif ($getdata->customer_status == 1)
  ...
  <!--model add -->
  <div class="modal fade"  wire:ignore.self id="modal-customer" style="display: none;" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            @if (!$showmodelf)
            <h4 class="modal-title">اضافه بيانات عميل جديد</h4>
            @else
            <h4 class="modal-title">تحديث بيانات عميل </h4>
          ...
          <div class="modal-body">
              ...
              <form wire:submit.prevent="{{!$showmodelf ? 'add' :'updateone'}}">
                ...
                <input class="form-control @error("customer_name")  is-invalid
                  
                @enderror" type="text" wire:model="customer_name" placeholder="(اجبارى*)اسم العميل"/>
                @error('customer_name')
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input class="form-control @error("customer_phone")  is-invalid 
                      
                    @enderror" type="text" wire:model="customer_phone" placeholder="(اجبارى*) رقم موبايل"/>
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input class="form-control" type="text" wire:model="customer_phone2" placeholder="(اختيارى) رقم موبايل 2"/>
              ...
              <div class=" col-sm-12 form-group">
                    ...
                    <textarea class="form-control"wire:model="customer_des"   id="bransh" rows="5" placeholder="(اختيارى)ملاحظات"></textarea>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                  ...
                  <input class="form-control" readonly type="text" wire:model="customer_name" />
                 
                  </div>
                  <div class=" col-sm-6 form form-group" wire:ignore>
                    <label for="">اسم الفرع</label>

                      <select class="form-control select2 select2-hidden-accessible" disabled data-placeholder="---"  wire:model="prenshes_id" style="width: 100%;"  tabindex="-1" aria-hidden="true">
                         <option></option>
                        @foreach ($preansh as $getpreansh)
                        <option value="{{ $getpreansh->id }}" {{ $prenshes_id ==  $getpreansh->id ? 'selected':'' }}> {{ $getpreansh->pre_name  }}</option> 
                        @endforeach
                  ...
                  <div class="col-sm-6 form-group">
                    <label for=""> تليفون العميل الاساسى </label>

                      <input class="form-control" type="text" readonly  wire:model="customer_phone" />
                  ...
                  <div class="col-sm-6 form-group">
                    <label for=""> تليفون العميل الفرعى </label>

           
                      <input class="form-control" readonly type="text" wire:model="customer_phone2"/>
                ...
                <div class=" col-sm-12 form-group">
                    <label for="">  ملاحظات </label>
                      ...
                      <textarea class="form-control"wire:model="customer_des" readonly  id="bransh" rows="5"></textarea>
