@extends("layouts.custom");
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-top: -24px;margin-right:0px ;background-color:#191d21;color:#fff">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <!-- SEARCH FORM -->
    <form class="ml-3 form-inline d-none">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" style="margin-top: 11px">
        <div class="input-group-append">
          <button class="btn btn-navbar" type="submit" style="margin-top: 11px">
    ...
    <ul class="navbar-nav mr-auto-navbav">
      ...
      <li class="nav-item">
        <a class="nav-link d-none" data-widget="control-sidebar" data-slide="true" href="#">
